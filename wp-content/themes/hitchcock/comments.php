...
<?php if ( have_comments() || comments_open() ) : ?>
	...
	<div class="comments-container">
			...
			<div class="comments-inner">
				...
				<h3 class="comments-title">
					...
					<div class="inner">
						...
						echo _n( 'Comentario' , 'Comentarios' , count($wp_query->comments_by_type[comment]), 'hitchcock' ); ?>
		...
		<?php $comments_args = array(
			...
			'title_reply' =>
				'<div class="inner">' . __('Dejá un comentario','hitchcock') . '</div>',
			...
			'comment_field' => 
				'<p class="comment-form-comment">
					<label for="comment">' . __('Comentario','hitchcock') . '</label>
			...
			'fields' => apply_filters( 'comment_form_default_fields', array(
				...
				'author' =>
					'<p class="comment-form-author">
						<label for="author">' . __('Nombre','hitchcock') . ( $req ? '<span class="required">*</span>' : '' ) . '</label> 
						<input id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30" />
					</p>',
				
				'email' =>
					'<p class="comment-form-email">
						<label for="email">' . __('Correo','hitchcock') . ( $req ? '<span class="required">*</span>' : '' ) . '</label> 
